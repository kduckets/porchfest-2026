  ...
  return (
    <div className="pb-16">
            ...
            return (
              <button
                ...
                className={clsx(
                  ...
                  isActive
                    ? "ring-2 ring-offset-2 ring-offset-cream scale-[1.02]"
                    : "hover:scale-[1.01]"
                )}
                style={{
                  background: isActive
              ...
              >
                ...
                <p
                  ...
                  style={{ color: isActive ? "rgba(255,255,255,0.7)" : cfg.text }}
                >
                  {cfg.time}
                </p>
                <p
                  className="text-sm font-medium"
                  style={{ color: isActive ? "rgba(255,255,255,0.9)" : cfg.text }}
                >
                  {zoneCounts[z]} acts
                </p>
                <div
      ...
      <section className="max-w-5xl mx-auto px-4 py-6 border-t border-blush/30">
        ...
        <p className="text-sm text-navy/50 mb-5">Filter by genre.</p>
        ...
        <AnimatePresence>
          {hasFilters && (
            <motion.section
              ...
              className="max-w-5xl mx-auto px-4 py-6 border-t border-blush/30"
            >
